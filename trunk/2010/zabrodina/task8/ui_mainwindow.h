...
**
** Created: Sun Nov 28 14:07:02 2010
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionCalculator->setCheckable(true);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QString::fromUtf8("centralWidget"));
        centralLog = new QTextEdit(centralWidget);
        centralLog->setObjectName(QString::fromUtf8("centralLog"));
        centralLog->setGeometry(QRect(0, -7, 611, 361));
